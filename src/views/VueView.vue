...
<template>
  <div class="vueView">
    ...
    <p>I started using Vue in personal projects, mostly using the CDN method. It made for a great way to start learning the options API before getting into built Vue. While working for CityGro, I worked with a full webpack Vue2 project, including Vue Router 3, VueX, and VueX ORM.</p>
